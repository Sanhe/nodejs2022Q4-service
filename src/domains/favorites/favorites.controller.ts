...
export class FavoritesController {
  ...
  async addTrack(
    ...
    const fav = await this.favoritesService.addTrack(track.id);
  ...
  async addArtist(
    ...
    const fav = await this.favoritesService.addArtist(artist.id);
  ...
  async addAlbum(
    ...
    const fav = await this.favoritesService.addAlbum(album.id);
